...
namespace Branta.Tests.Automation;
...
public class ClipboardGuardianTest
{
    ...
    {
        Assert.That(isValid, Is.EqualTo(ClipboardGuardian.CheckForBitcoinAddress(clipboardContent)));
    }
    ...
    {
        var clipboardGuardian = new ClipboardGuardian(null, null);
    ...
    {
        Assert.That(isValid, Is.EqualTo(ClipboardGuardian.CheckForXPub(clipboardContent)));
    }
    ...
    {
        Assert.That(isValid, Is.EqualTo(ClipboardGuardian.CheckForXPrv(clipboardContent)));
    ...
    {
        Assert.That(isValid, Is.EqualTo(ClipboardGuardian.CheckForNPub(clipboardContent)));
    }
    ...
    {
        Assert.That(isValid, Is.EqualTo(ClipboardGuardian.CheckForNPrv(clipboardContent)));
    }
}
